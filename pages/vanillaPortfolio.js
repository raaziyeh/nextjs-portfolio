...
import portfolioVanillaImg from "../public/assets/projects/vanilla-portfolio.png"
import Link from "next/link"

const portfolioVanilla = () => {
	return (
		<div className="w-full">
			<div className="relative w-100vw h-[30vh] md:h-[40vh]">
				<div className="absolute top-0 left-0 w-full h-full bg-black/70 z-10" />
				<Image
					src={portfolioVanillaImg}
				...
				<div className="absolute top-[70%] max-w-[1240px] w-full p-2 left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10">
					<h2 className="py-2">Vanilla Portfolio</h2>
...
export default portfolioVanilla
